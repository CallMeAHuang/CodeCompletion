# nohup run_bash/knn_gpt2.sh > log_files/knn_gpt2.log 2>&1 &
model_type=gpt2
...
log_file=knn_gpt2_0226.log
task_name=knn_gpt2_0226
task_name_build=knn_gpt2_build_0226
# 1. build the database (same as token completion for Android.)
scenario_dir=${data_dir}/token_completion_debug2/Android
